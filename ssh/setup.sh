...
IZIN=$( curl https://raw.githubusercontent.com/namydeveloper/MBTunnel/tree/main/ssh | grep $MYIP )
if [ $MYIP = $MYIP ]; then
...
wget https://raw.githubusercontent.com/namydeveloper/MBTunnel/tree/main/ssh/cf.sh && chmod +x cf.sh && ./cf.sh
#install ssh ovpn
wget https://raw.githubusercontent.com/namydeveloper/MBTunnel/main/ssh-vpn.sh && chmod +x ssh-vpn.sh && screen -S ssh-vpn ./ssh-vpn.sh
