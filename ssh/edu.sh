...
wget -q -O /usr/local/bin/edu-ssh https://raw.githubusercontent.com/namydeveloper/MBTunnel/main/proxy-template.py
...
wget -q -O /usr/local/bin/edu-ovpn https://raw.githubusercontent.com/namydeveloper/MBTunnel/main/edu-op.py
