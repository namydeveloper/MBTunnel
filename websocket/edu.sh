...
# Link Hosting Kalian
namydev="raw.githubusercontent.com/namydeveloper/MBTunnel/main/websocket"

# Getting Proxy Template
wget -q -O /usr/local/bin/ws-nontls https://${namydev}/websocket.py
...
# Getting Proxy Template
wget -q -O /usr/local/bin/ws-ovpn https://${namydev}/ws-ovpn.py
...
# Getting Proxy Template
wget -q -O /usr/local/bin/ws-tls https://${namydev}/ws-tls
