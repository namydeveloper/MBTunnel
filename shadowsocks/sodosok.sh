...
# Link Hosting Kalian
namydev="raw.githubusercontent.com/namydeveloper/MBTunnel/main/shadowsocks"
...
cd /usr/bin
wget -O addss "https://${namydev}/addss.sh"
wget -O delss "https://${namydev}/delss.sh"
wget -O cekss "https://${namydev}/cekss.sh"
wget -O renewss "https://${namydev}/renewss.sh"
chmod +x addss
chmod +x delss
chmod +x cekss
chmod +x renewss
