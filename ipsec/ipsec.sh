...
# ==================================================
# Link Hosting Kalian
namydev="raw.githubusercontent.com/namydeveloper/MBTunnel/main/ipsec"
...
wget -O /usr/bin/addl2tp https://${namydev}/addl2tp.sh && chmod +x /usr/bin/addl2tp
wget -O /usr/bin/dell2tp https://${namydev}/dell2tp.sh && chmod +x /usr/bin/dell2tp
wget -O /usr/bin/addpptp https://${namydev}/addpptp.sh && chmod +x /usr/bin/addpptp
wget -O /usr/bin/delpptp https://${namydev}/delpptp.sh && chmod +x /usr/bin/delpptp
wget -O /usr/bin/renewpptp https://${namydev}/renewpptp.sh && chmod +x /usr/bin/renewpptp
wget -O /usr/bin/renewl2tp https://${namydev}/renewl2tp.sh && chmod +x /usr/bin/renewl2tp
