...
# Link Hosting Kalian
namydev="raw.githubusercontent.com/namydeveloper/MBTunnel/main/ssr"
...
Start_SSR(){
	check_pid
	wget -O /etc/init.d/ssrmu "https://${namydev}/ssrmu"
...
Install_SSR
wget -O /usr/bin/ssr https://${namydev}/ssrmu.sh && chmod +x /usr/bin/ssr
wget -O /usr/bin/addssr https://${namydev}/addssr.sh && chmod +x /usr/bin/addssr
wget -O /usr/bin/delssr https://${namydev}/delssr.sh && chmod +x /usr/bin/delssr
wget -O /usr/bin/renewssr https://${namydev}/renewssr.sh && chmod +x /usr/bin/renewssr
