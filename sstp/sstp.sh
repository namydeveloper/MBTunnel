...
# Link Hosting Kalian
namydev="raw.githubusercontent.com/namydeveloper/MBTunnel/main/sstp"
...
wget -O /etc/accel-ppp.conf "https://${namydev}/accel.conf"
...
#input perintah sstp
wget -O /usr/bin/addsstp https://${namydev}/addsstp.sh && chmod +x /usr/bin/addsstp
wget -O /usr/bin/delsstp https://${namydev}/delsstp.sh && chmod +x /usr/bin/delsstp
wget -O /usr/bin/ceksstp https://${namydev}/ceksstp.sh && chmod +x /usr/bin/ceksstp
wget -O /usr/bin/renewsstp https://${namydev}/renewsstp.sh && chmod +x /usr/bin/renewsstp
rm -f /root/sstp.sh
